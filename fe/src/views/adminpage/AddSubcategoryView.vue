    ...
    <form @submit.prevent="addSubcategory">
      <div class="space-y-12">
        <div class="ms-4 border-b border-gray-900/10 pb-12">
          ...
          >
            Provide the details for your new subcategory.
          </p>
...
export default {
  ...
  methods: {
    ...
    addSubcategory() {
      ...
      axios
        .post("/api/v1/subcategory", this.subcategory)
        .then((response) => {
          console.log(response.data);
          this.message = "Subcategory data has been successfully saved.";
          this.success = true;
          this.open = true;
        })
        .catch((error) => {
          console.log(error);
          this.open = true;
          this.message = "Failed to add subcategory. Please try again.";
          this.success = false;
        });
    },
    navigate() {
