    ...
    <form @submit.prevent="editProduct">
      <div class="space-y-12">
        <div class="ms-4 border-b border-gray-900/10 pb-12">
          ...
          >
            Provide the details for your category.
          </p>
...
export default {
  ...
  methods: {
    fetchData() {
      axios
        .get("/api/v1/category/" + this.category_id)
        .then((response) => {
    ...
    editProduct() {
      axios
        .put("/api/v1/category/" + this.category_id, this.category)
        .then((response) => {
          console.log(response.data);
          this.message = "Category data has been successfully updated.";
          this.success = true;
          this.open = true;
        })
        .catch((error) => {
