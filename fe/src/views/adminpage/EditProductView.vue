...
export default {
  ...
  methods: {
    ...
    fetchData() {
      axios
        .get("/api/v1/product/" + this.product_id)
        .then((response) => {
          ...
          this.formattedPrice = this.product.price.toLocaleString("id-ID");
          this.selectedColor = item.color;
          this.selectedSubcategory = item.product.sub_category;
    ...
    editProduct() {
      ...
      axios
        .put("/api/v1/product/" + this.product_id, this.product)
        .then((response) => {
          console.log(response.data);
          this.message = "Product data has been successfully updated.";
          this.success = true;
          this.open = true;
        })
        .catch((error) => {
