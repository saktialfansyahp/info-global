<template>
  <body class="h-full">
    <div
      class="flex min-h-full flex-1 flex-col justify-center px-6 py-10 lg:px-8"
    >
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        />
        <h2
          class="mt-2 text-center text-xl font-bold leading-9 tracking-tight text-gray-900"
        >
                        ...
                        <div class="mx-auto text-center sm:mt-0 sm:text-left">
                          ...
                          <div class="mt-2 pb-4">
                            <p class="text-sm text-gray-500">
                              Registration was successful. You will redirect to
                              sign in.
                            </p>
                          </div>
